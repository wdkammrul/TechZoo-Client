...
const Overview = () => {
    return (
        <div className="w-11/12 md:w-11/12 lg:w-full mx-auto hero rounded-lg bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse justify-around gap-8 mx-auto">
                ...
                <div className="p-10">
                    <h1 className="text-3xl lg:text-5xl font-bold">Tech Overview</h1>
                    <p className="py-6">Discover tech trends, brands, and innovations in our Quick Overview.</p>
